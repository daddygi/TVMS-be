...
const apprehensionSchema = new Schema<IApprehensionDocument>(
  {
    ...
    dateOfApprehension: { type: Date, default: null, index: true },
    timeOfApprehension: { type: String, default: null },
    agency: { type: String, default: null, index: true },
    ...
    violation: { type: String, default: null, index: true },
    confiscatedItem: {
    ...
    placeOfApprehension: { type: String, default: null, index: true },
